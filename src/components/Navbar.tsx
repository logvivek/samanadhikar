...
import kamadhenuCowCalfImg from "../assets/images/kamadhenu_cow_calf_1786714164676.jpg";
        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="w-13 h-13 rounded-xl bg-gradient-to-tr from-amber-500 via-orange-500 to-amber-600 p-0.5 shadow-md group-hover:scale-105 transition-transform overflow-hidden flex items-center justify-center shrink-0">
              <img 
                src={kamadhenuCowCalfImg || "/images/kamadhenu_cow_calf.jpg"} 
                alt="समान अधिकार पार्टी - जय गौ माता कामधेनु चुनाव चिन्ह" 
                loading="eager"
                ...
                onError={(e) => {
                  ...
                  if (!target.dataset.triedFallback) {
                    ...
                    target.src = "/images/kamadhenu_cow_calf.jpg";
